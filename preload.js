...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  onConnectionUpdate: (cb) => ipcRenderer.on('connection-update', (_, data) => cb(data)),
  onRunningUpdate: (cb) => ipcRenderer.on('running-update', (_, data) => cb(data)),
  onLogEntry: (cb) => ipcRenderer.on('log-entry', (_, data) => cb(data)),
  onPickLocationResult: (cb) => ipcRenderer.on('pick-location-result', (_, data) => cb(data)),
